...
class CategoriesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GridView( // Grid is just like ListView (is scrollable as default)
      children: <Widget>[
      ...
      */
      gridDelegate: const SliverGridDelegateWithMaxCrossAxisExtent( // scrollable areas on the screen
        maxCrossAxisExtent: 200, // (1 item/row for device of 300px width, 2 items sit side by side for 500px width)
        childAspectRatio: 3 / 2, // for 200 width, we have 300 height
        crossAxisSpacing: 20, // how much distance is between rows or columns in the grid.
        mainAxisSpacing: 20,
      ),
    );
  }
